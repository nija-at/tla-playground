...
\fl{}\moduleLeftDash\cl{ {\MODULE} Exponentiation}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, Sequences ,\, TLC}
\fl{}
\fl{}
\fl{}
\fl{ {\p@mmalgorithm} Exponentiation {\p@lbrace}}
 \fl{ {\p@variables} m \.{=} 3 ,\, n \.{=} 3 ,\, e \.{=} 1 ,\, i \.{=} n
 {\p@semicolon}}
\fl{ {\p@lbrace}}
\fl{ {\p@assert} n}\al{9}{2}{ \.{\geq} 0 {\p@semicolon}}
\fl{}
\fl{ {\p@while} {\p@lparen} i}\al{11}{3}{ \.{>} 0 {\p@rparen} {\p@lbrace}}
\fl{ e}\al{12}{1}{ \.{:=}}\al{12}{2}{ e \.{*} m}\al{12}{5}{ {\p@semicolon}}
\fl{ i}\al{13}{1}{ \.{:=}}\al{13}{2}{ i \.{-} 1}\al{13}{5}{ {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{}
\fl{ {\p@assert} e \.{=} m ^{ n} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}%
\@y{}%
}
...
\fl{}
\fl{}
\fl{ {\VARIABLES} m ,\, n ,\, e ,\, pc}
\fl{}
\fl{ vars}\al{24}{1}{ \.{\defeq} {\langle} m ,\, n ,\, e ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{26}{1}{ \.{\defeq}}\al{26}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{27}{1}{ m}\al{27}{2}{ \.{=}}\al{27}{3}{ 3}
\fl{ \.{\land}}\al{28}{1}{ n}\al{28}{2}{ \.{=}}\al{28}{3}{ 3}
\fl{ \.{\land}}\al{29}{1}{ e}\al{29}{2}{ \.{=} 1}
\fl{ \.{\land}}\al{30}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
 \fl{ Lbl\_1}\al{32}{1}{ \.{\defeq}}\al{32}{2}{ \.{\land}}\al{32}{3}{ pc
 \.{=}\@w{Lbl\_1}}
 \fl{ \.{\land}}\al{33}{1}{ Assert ( n \.{\geq} 0 ,\,\@w{Failure\ of\
 assertion\ at\ line\ 10,\ column\ 5.} )}
\fl{ \.{\land}}\al{34}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{35}{1}{ {\UNCHANGED} {\langle} m ,\, n ,\, e {\rangle}}
\fl{}
 \fl{ Lbl\_2}\al{37}{1}{ \.{\defeq}}\al{37}{2}{ \.{\land}}\al{37}{3}{ pc
 \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{38}{1}{ {\IF}}\al{38}{2}{ n \.{>} 0}
 \fl{ \.{\THEN}}\al{39}{1}{ \.{\land}}\al{39}{2}{ e \.{'}}\al{39}{4}{
 \.{=}}\al{39}{5}{ e \.{*} m}
\fl{ \.{\land}}\al{40}{1}{ n \.{'}}\al{40}{3}{ \.{=}}\al{40}{4}{ n \.{-} 1}
\fl{ \.{\land}}\al{41}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
\fl{ \.{\ELSE}}\al{42}{1}{ \.{\land}}\al{42}{2}{ PrintT ( e )}
\fl{ \.{\land}}\al{43}{1}{ Assert (}\al{43}{3}{ e \.{=} m ^{ n} ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 19,\ column\ 5.} )}
\fl{ \.{\land}}\al{45}{1}{ pc \.{'} \.{=}\@w{Done}}
\fl{ \.{\land}}\al{46}{1}{ {\UNCHANGED} {\langle} n ,\, e {\rangle}}
\fl{ \.{\land}}\al{47}{1}{ m \.{'} \.{=} m}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{52}{1}{ \.{\defeq}}\al{52}{2}{ Lbl\_1}\al{52}{3}{ \.{\lor}
 Lbl\_2}
\fl{ \.{\lor}}\al{53}{1}{ Terminating}
\fl{}
 \fl{ Spec}\al{55}{1}{ \.{\defeq}}\al{55}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
